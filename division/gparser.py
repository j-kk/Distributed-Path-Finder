...
class GraphParser:
    ...
    def parse_txt(self, filestream: TextIOWrapper) -> None:
    ...
    def parse_csv(self, vert_filestream: TextIOWrapper, edge_filestream: TextIOWrapper) -> None:
    ...
    def get_graph(self) -> Graph2D:
        return self.graph

    def read_number(self, filestream: TextIOWrapper) -> int:
        txt = filestream.readline()
        return int(txt)

    def read_vertex(self, line: str, separator: str=' ') -> None:
    ...
    def read_edge(self, line: str, separator: str=' ') -> None:
